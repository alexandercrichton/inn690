...
//Last modified: Fri, Oct 10, 2014 01:20:39 AM
//Codeset: 932
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 26.924719071187479 19.343035795832982 -21.065669296987686 ;
	setAttr ".r" -type "double3" -23.1383527294803 138.9999999999645 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 44.821869662030423;
...
createNode mesh -n "polySurfaceShape1" -p "polySurface1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 4 ".pt[225:228]" -type "float3"  0.14835191 0.10650143 -0.15904224 
